...
func syncOpenShiftAPIServer_v311_00_to_latest(c OpenShiftAPIServerOperator, originalOperatorConfig *operatorv1.OpenShiftAPIServer) (bool, error) {
	...
	directResourceResults := resourceapply.ApplyDirectly(c.kubeClient, c.eventRecorder, v311_00_assets.Asset,
		...
		"v3.11.0/openshift-svcat-apiserver/apiserver-clusterrolebinding.yaml",
		"v3.11.0/openshift-svcat-apiserver/svc.yaml",
		"v3.11.0/openshift-svcat-apiserver/sa.yaml",
		"v3.11.0/openshift-svcat-apiserver/cr1.yaml",
		"v3.11.0/openshift-svcat-apiserver/cr2.yaml",
		"v3.11.0/openshift-svcat-apiserver/cr3.yaml",
		"v3.11.0/openshift-svcat-apiserver/cr4.yaml",
		"v3.11.0/openshift-svcat-apiserver/cr7.yaml",
		"v3.11.0/openshift-svcat-apiserver/cr8.yaml",
		"v3.11.0/openshift-svcat-apiserver/cr9.yaml",
		"v3.11.0/openshift-svcat-apiserver/cr10.yaml",
		"v3.11.0/openshift-svcat-apiserver/crb1.yaml",
		"v3.11.0/openshift-svcat-apiserver/crb2.yaml",
		"v3.11.0/openshift-svcat-apiserver/crb3.yaml",
		"v3.11.0/openshift-svcat-apiserver/crb4.yaml",
		"v3.11.0/openshift-svcat-apiserver/crb5.yaml",
		"v3.11.0/openshift-svcat-apiserver/crb6.yaml",
		"v3.11.0/openshift-svcat-apiserver/crb7.yaml",
		"v3.11.0/openshift-svcat-apiserver/role1.yaml",
		"v3.11.0/openshift-svcat-apiserver/role2.yaml",
		"v3.11.0/openshift-svcat-apiserver/role3.yaml",
		"v3.11.0/openshift-svcat-apiserver/roleb1.yaml",
		"v3.11.0/openshift-svcat-apiserver/roleb2.yaml",
		"v3.11.0/openshift-svcat-apiserver/roleb3.yaml",
		"v3.11.0/openshift-svcat-apiserver/sa1.yaml",
	)
